...
cursor.execute("select route from model_route")
...
for route in routes:
    ...
    cursor.execute("ALTER TABLE `dublin_bus_time`.`route_" + route[0] + """` 
    ...
    cursor.execute("update dublin_bus_time.route_" + route[0] + """
    ...
    cursor.execute("update dublin_bus_time.route_" + route[0] + """ b
